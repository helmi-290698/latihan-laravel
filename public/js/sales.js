$('#inventory_id').select2({
    dropdownParent: $('#modalEditSales')
});

$(document).on("submit", "#form-delete-sales", function(e) {
    e.preventDefault();
...
$(document).on('click','.open_edit_sales',function(){
    const id= $(this).val();
...
$("#form-update-sales").on("submit", function(e) {
...
$('#modalEditSales').on('hidden.bs.modal', function () {
    $('#inventory_id').empty(); 
});